...
function DrawingPage({T,tn,onBack}){
  ...
  const LABEL_SIZE=16;
  const BG_OPTIONS=["#ffffff","#e8f8ee"];
      ...
      <div style={{flex:1,minHeight:0,display:"flex",overflow:"hidden"}}>
        {activeSeries===null?(
          ...
          <div style={{width:68,flexShrink:0,background:T.card,borderRight:"1px solid "+T.border,display:"flex",flexDirection:"column",zIndex:2,minHeight:0}}>
            ...
            <div style={{flex:1,minHeight:0,overflowY:"scroll",WebkitOverflowScrolling:"touch",overscrollBehavior:"contain",padding:"4px 4px calc(180px + env(safe-area-inset-bottom))",touchAction:"pan-y"}}>
