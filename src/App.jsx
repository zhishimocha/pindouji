...
function FocusMode({T,tn,task,onDeductStock,onExit,onComplete}){
  ...
  useEffect(()=>{
    ...
    if(!activeColor){
      ...
      ctx.putImageData(copy,0,0);return;
    }
    ...
    for(let i=0;i<d.length;i+=4){
      ...
      if(dist<=TOLERANCE){d[i]=HIGHLIGHT[0];d[i+1]=HIGHLIGHT[1];d[i+2]=HIGHLIGHT[2];d[i+3]=255;}
